...
<style>
  ...
  #og{width:1200px;height:630px;background:#F7F3EA;display:flex;align-items:center;
  ...
  #mark{font-family:'Literata',serif;font-weight:700;font-size:130px;line-height:1;
        color:#16130E;letter-spacing:-0.015em;margin:0}
  #rule{width:110px;height:1px;background:#16130E;opacity:.26;margin:34px 0 30px}
  #sub{font-family:'Source Sans 3',sans-serif;font-weight:400;font-size:30px;
       line-height:1.35;color:color-mix(in srgb,#16130E 60%,#F7F3EA);margin:0;max-width:560px;white-space:nowrap}
  ...
  #frame{border:1px solid rgba(22,19,14,.26);padding:14px;
         background:color-mix(in srgb,#F7F3EA 55%,#fff)}
