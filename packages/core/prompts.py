...
- TWO-POINT BEFORE/AFTER or an ORDERED PROGRESSION over time/steps (2020→2023 capacity, before vs after intervention) — use chart_data with chart_type "line"; the line communicates direction. A two-bar chart hides the trajectory.
